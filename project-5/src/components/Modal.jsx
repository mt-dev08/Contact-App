...
const Modal = ({onClose,isOpen,children}) => {
  return createPortal ( // we use create portal coz sometime our css got confused because of position, root element has different positions and our modal has different.
